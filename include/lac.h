...
private:
    ...
    std::shared_ptr<paddle_infer::Predictor> _predictor;    // 预测器
    std::unique_ptr<paddle_infer::Tensor> _input_tensor;  // 输入空间
    std::unique_ptr<paddle_infer::Tensor> _output_tensor; // 输出空间
